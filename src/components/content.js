...
export default class Content extends React.Component {
    ...
    handleMouseMove (e) {
        ...
        if (this.state.isDrawing) {
            if (this.props.activeItem === "Pencil" || this.props.activeItem === "Brush") {
                ctx.lineTo(e.clientX - this.state.offsetX, e.clientY - this.state.offsetY);
                ctx.stroke();
            }
            if (this.props.activeItem === "Line") {
                ...
                ctxOverlay.lineTo(e.clientX - this.state.offsetX, e.clientY - this.state.offsetY);
                ctxOverlay.stroke();
            ...
            if (this.props.activeItem === "Rectangle") { 
                ...
                ctxOverlay.strokeRect(this.state.startX, this.state.startY, width, height);
            }
        }
      }
    ...
    render () {
        return (
            <div className="content">
                <Toolbox items={this.props.items}
